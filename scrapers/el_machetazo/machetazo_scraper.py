"""Scraper de El Machetazo: intenta extracción real (best-effort) y cae a fixtures."""
...
_FIXTURE = Path(__file__).parent / "fixtures" / "el-machetazo.json"


class MachetazoScraper(BaseScraper):
    ...
    def _load_fixtures(self) -> List[RawProduct]:
        ...
        return [
            RawProduct(
                ...
                source_url=self.target_url or "fixture://el-machetazo",
            )
            for r in rows
        ]
